...
function AppContent() {
  ...
  // Helper for triggering WhatsApp chat with custom text
  ...
  // Product inquiry from modal handler
  ...
  return (
    <div className="min-h-screen bg-[#FDF6F0] text-[#1A1A1A] flex flex-col font-['Plus_Jakarta_Sans',sans-serif] selection:bg-[#FF9F73]/30">
      ...
      {/* Sticky Header with active page indicator */}
      <Header
      ...
      {/* Main Page Content - Strictly Isolated per Route/Page */}
      <main className="flex-1">
        
        {/* 1. HOME PAGE (/page.tsx) - Corporate Overview, Vision Mission, & Our Product Preview */}
        {activePage === 'home' && (
        ...
        {/* 2. PRODUCT PAGE (/product/page.tsx) - Product Showcase Catalog */}
        {activePage === 'product' && (
        ...
        {/* 3. CAREER PAGE (/career/page.tsx) - Job Openings, Flyer Boxes, & Employee Flip-Cards */}
        {activePage === 'career' && (
        ...
        {/* 4. GALLERY PAGE (/gallery/page.tsx) - Masonry Grid documentation of company building/workshop */}
        {activePage === 'gallery' && (
          <div className="animate-in fade-in duration-300 py-6">
        ...
        {/* 5. CONTACT PAGE (/contact/page.tsx) - Address, official phone/email & consultation form */}
        {activePage === 'contact' && (
          <div className="animate-in fade-in duration-300 py-6">
